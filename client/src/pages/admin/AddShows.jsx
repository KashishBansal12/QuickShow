      ...
      <div className='group flex flex-wrap gap-4 mt-4 w-max'>
        ...
        <div className="relative rounded-lg overflow-hidden">
          <img
            ...
            alt={movie.title} className="w-full object-cover brightness-90"/>
          ...
          <p className="text-gray-300">
           {kConvertor(movie.vote_count)} Votes</p>
          </div>
        </div>
...
<button className='bg-primary text-white px-8 py-2 rounded hover:bg-primary/90 
